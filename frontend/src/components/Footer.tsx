...
=======
    <footer className="bg-card border-t border-border pt-12 pb-6" role="contentinfo">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div className="md:col-span-1">
            <h3 className="text-lg font-bold gradient-text mb-3">QuickStore</h3>
            <p className="text-sm text-muted-foreground">
              Premium e-commerce solutions for modern brands. Quality products, exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/products?featured=true" className="text-muted-foreground hover:text-brand transition-colors">
                  Featured
                </Link>
              </li>
              <li>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="text-sm font-semibold mb-3 text-foreground">Customer Service</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <span className="text-muted-foreground">Shipping Info</span>
              </li>
              <li>
                <span className="text-muted-foreground">Returns & Exchanges</span>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                className="p-2 bg-muted rounded-lg hover:bg-brand-light hover:text-brand transition-colors"
                aria-label="Twitter"
              >
        ...
        <div className="pt-6 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © {currentYear} QuickStore Inc. All rights reserved.
          </p>
